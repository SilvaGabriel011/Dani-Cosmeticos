      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground">Maior valor de vendas em uma semana</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground">Média de vendas por semana</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground">Total de vendas no ano</p>
          </CardContent>
        </Card>
      </div>
    </div>
