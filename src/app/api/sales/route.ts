    ...
    const [sales, total] = await Promise.all([
      prisma.sale.findMany({
        ...
        include: {
          ...
          items: { select: { id: true, quantity: true, unitPrice: true, originalPrice: true, total: true, addedAt: true, isBackorder: true, product: { select: { id: true, name: true, code: true, category: { select: { id: true, name: true } } } } } },
